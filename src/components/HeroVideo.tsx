    ...
    >
      ...
      <div className="w-full md:w-1/2 relative h-[250px] sm:h-[300px] md:h-[450px] flex items-center justify-center order-1 md:order-2">
        ...
        <video 
          ...
          muted 
          playsInline
          className="relative z-10 w-full h-full object-contain drop-shadow-[0_20px_20px_rgba(0,0,0,0.5)] scale-100 sm:scale-110 md:scale-125 origin-center transition-transform hover:scale-105 md:hover:scale-[1.4] duration-500"
        />
      </div>
    </motion.div>
  );
